			...
			if(preg_match('/^[a-zA-ZñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["regUsuario"]) &&
			   ...
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["regPassword"])){
				...
				if($respuesta == "ok"){
					...
					$mail->setFrom('info@fisiiterapiaenbogota.com', 'Adriana Lucía Ramírez Bonilla');

					$mail->addReplyTo('info@fisiiterapiaenbogota.com', 'Adriana Lucía Ramírez Bonilla');
					...
					$mail->msgHTML('<div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-bottom:40px">
						...
						<center>
							...
							<img style="padding:20px; width:10%" src="http://localhost/frontend/vistas/img/plantila/logo.png">
						...
						<div style="position:relative; margin:auto; width:600px; background:white; padding:20px">
							...
							<img style="padding:20px; width:15%" src="http://localhost/frontend/vistas/img/plantila/icon-email.png">
					...
					$mail->Username = "sorteosypromociones.winkas@gmail.com";
					$mail->Password = "^Z=cWO3D_Oru";
