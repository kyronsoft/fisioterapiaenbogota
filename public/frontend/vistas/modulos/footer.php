		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-6 col-xs-12 text-left infoContacto">
				...
				<h5>
					...
					<i class="fa fa-phone-square" aria-hidden="true"></i> +57 310 695 1073

					<br><br>

					<i class="fa fa-envelope" aria-hidden="true"></i> info@fisioterapiaenbogota.com

					<br><br>

					<i class="fa fa-map-marker" aria-hidden="true"></i> www.fisioterapiaenbogota.com
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-6 col-xs-12 text-left text-muted">
				...
				<h5>&copy; 2020 Tienda Virtual ajustada por <a href="https://www.kyronsoft.com">Kyronsoft</a></h5>
