...
<header class="container-fluid">
	...
	<div class="container">
		...
		<div class="row d-flex" id="cabezote">

			<!--=====================================
			LOGOTIPO
			======================================-->

			<div class="col-lg-3 col-md-3 col-sm-2 col-xs-12 align-self-center" id="logotipo">

				<a href="http://localhost/fisioterapiaenbogota/public">
