...
<body style="background-color: #fff">
    <div id="app">
        ...
        <div class="owl-carousel owl-theme">
            ...
            @if ($route->uri == '/')
                <div><img src="{{ url('/') }}/storage/Fisioterapia-y-fisioterapeuta-en-bogota.jpg"
                        alt="Fisioterapia-y-fisioterapeuta-en-bogota">
                    <p id="titulo2-carousel">Telerehabilitación</p>
                    <div class="row" id="subtitulo2-carousel">
                        <div class="col">
                            <span id="slider-icon1"><img src="{{ url('/') }}/storage/slider-icon2.png"
                                    alt="slider-icon2"></span>
                            <p>Independencia</p>
                        </div>
                        <div class="col">
                            <span id="slider-icon2"><img src="{{ url('/') }}/storage/slider-icon2.png"
                                    alt="slider-icon2"></span>
                            <p>Calidad</p>
                        </div>
                        <div class="col">
                            <span id="slider-icon3"><img src="{{ url('/') }}/storage/slider-icon2.png"
                                    alt="slider-icon2"></span>
                            <p>Conveniencia</p>
                        </div>
                    </div>
            ...
            @elseif ($route->uri == 'en')
                <div><img src="{{ url('/') }}/storage/Fisioterapia-y-fisioterapeuta-en-bogota.jpg"
                        alt="Fisioterapia-y-fisioterapeuta-en-bogota">
                    <p id="titulo2-carousel">Telerehabilitation</p>
                    <div class="row" id="subtitulo2-carousel">
                        <div class="col">
                            <span id="slider-icon1"><img src="{{ url('/') }}/storage/slider-icon2.png"
                                    alt="slider-icon2"></span>
        ...
        @include('website.inicio-seccion1')
        @include('website.inicio-seccion2')
        @include('website.inicio-seccion3')
        @include('website.inicio-seccion4')
        @include('website.inicio-seccion5')
        @include('website.inicio-seccion6')
        @include('website.inicio-seccion7')
        @include('website.inicio-seccion8')
