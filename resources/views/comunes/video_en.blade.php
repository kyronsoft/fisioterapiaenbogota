<section class="container-fluid d-flex justify-content-end seccion-cinco">
    <div class="col-xs-6 col-md-6 align-self-center bg-white columna">
        <h3 class="text-center">{{$textos[45]['english']}}</h3>
        <h4 class="text-center">{{$textos[46]['english']}}</h4>
        <div class="row">
        ...
        <div class="row d-flex justify-content-center">
            <p class="text-justify">{{$textos[47]['english']}}</p>
            <a href="#" class="btn btn-primary btn-block">{{$textos[48]['english']}}</a>
        </div>
    </div>
</section>