    ...
    <div class="container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Sección Dos</li>
            </ol>
        </nav>
        <form class="mb-5" action="/ksadmin/inicio/seccion2/{{ $textos[0]->id }}" method="POST">
            @method('PUT')
            @csrf
        ...
        <hr>
        <form class="mb-5" action="/ksadmin/inicio/seccion2/{{ $textos[1]->id }}" method="POST">
            @method('PUT')
            @csrf
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
        ...
        <hr>
        <form class="mb-5" action="/ksadmin/inicio/seccion2/{{ $textos[2]->id }}" method="POST">
            @method('PUT')
            @csrf
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
        ...
        <hr>
        <form class="mb-5" action="/ksadmin/inicio/seccion2/{{ $textos[3]->id }}" method="POST">
            @method('PUT')
            @csrf
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
        ...
        <hr>
        <form class="mb-5" action="/ksadmin/inicio/seccion2/{{ $textos[4]->id }}" method="POST">
            @method('PUT')
            @csrf
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
        ...
        <hr>
        <form class="mb-5" action="/ksadmin/inicio/seccion2/{{ $textos[5]->id }}" method="POST">
            @method('PUT')
            @csrf
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
