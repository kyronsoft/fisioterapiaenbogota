...
@section('content')
    <div class="container-fluid">
        ...
        <form class="mb-5" action="/ksadmin/inicio/seccion4/{{ $textos[0]->id }}" method="POST">
            @method('PUT')
            @csrf
        ...
        <hr>
        <form class="mb-5" action="/ksadmin/inicio/seccion4/{{ $textos[1]->id }}" method="POST">
            @method('PUT')
            @csrf
            <input type="hidden" name="id" value="{{ $textos[1]->id }}">
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
        ...
        <hr>
        <form class="mb-5" action="/ksadmin/inicio/seccion4/{{ $textos[2]->id }}" method="POST">
            @method('PUT')
            @csrf
            <input type="hidden" name="id" value="{{ $textos[2]->id }}">
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
