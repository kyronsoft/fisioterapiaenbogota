...
@section('content')
    <div class="container-fluid">
        ...
        <form class="mb-5" action="/ksadmin/blog/articulos_en/{{ $articulo[0]->id_articulo }}/actualizar" method="POST"
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="descripcion" name="descripcion"
                                value="{{ $articulo[0]->descripcion_en }}">
                        </div>
                    </div>
                </div>
                <div class="row">
            ...
            <div class="form-group">
                ...
                <textarea name="content_english" class="editor_blog">{{ $articulo[0]->contenido_en }}</textarea>
            </div>
        </form>
    </div>
@endsection
