...
@section('content')
    <div class="container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">Página Nace</li>
                <li class="breadcrumb-item active" aria-current="page">Secciones (5)</li>
            </ol>
        </nav>
        <form class="mb-5" action="/ksadmin/nace/{{ $textos[0]->id }}" method="POST">
            @method('PUT')
            @csrf
        ...
        <hr>
        <form class="mb-5" action="/ksadmin/nace/{{ $textos[1]->id }}" method="POST">
            @method('PUT')
            @csrf
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
        ...
        <hr>
        <form class="mb-5" action="/ksadmin/nace/{{ $textos[2]->id }}" method="POST">
            @method('PUT')
            @csrf
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
        ...
        <hr>
        <form class="mb-5" action="/ksadmin/nace/{{ $textos[3]->id }}" method="POST">
            @method('PUT')
            @csrf
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
        ...
        <hr>
        <form class="mb-5" action="/ksadmin/nace/{{ $textos[4]->id }}" method="POST">
            @method('PUT')
            @csrf
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
