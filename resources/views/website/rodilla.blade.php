    ...
    <div id="app">
        @if ($idioma == 'ES')
                    ...
                    <div class="col-xs-12 col-md-6">
                        ...
                        <div class="container d-flex justify-content-center">
                            <div class="col-xs-7 col-md-10">
                                <div class="card">
                                    <h4 class="card-header text-center bg-info text-white">Dolor de Rodilla</h4>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="container folleto-boton">
                <div class="row d-flex justify-content-center">
                    <div class="col-xs-12 col-md-8">
                        <img src="{{ url('/') }}/storage/port-4-spa.png" class="img-fluid" alt="" id="libro_dolor">
        ...
        @elseif ($idioma == 'EN')
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-xs-12 col-md-6">
                        ...
                        <div class="container d-flex justify-content-center">
                            <div class="col-xs-7 col-md-10">
                                <div class="card">
                                    <h4 class="card-header text-center bg-info text-white">Hip And Knee Pain</h4>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="container folleto-boton">
                <div class="row d-flex justify-content-center">
                    <div class="col-xs-12 col-md-8">
                        <img src="{{ url('/') }}/storage/port-4-eng.png" class="img-fluid" alt="" id="libro_dolor">
                        <a href="{{ url('/') }}/download_knee" class="btn btn-info">Descargar</a>
                    </div>
                </div>
            </section>
        @endif
