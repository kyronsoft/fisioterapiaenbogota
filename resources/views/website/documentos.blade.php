                ...
                <div class="row align-self-center">
                    <form action="{{ url('/') }}/requisitos" method="POST">
                        ...
                        <div class="col-xs-12 align-self-center">
                            <h3 class="text-center my-5">Este contenido está protegido por contraseña. Para verlo, por
                                favor,
                                introduce tu contraseña a continuación:</h3>
                            <h4 class="text-center">Contraseña:</h4>
                            <div class="text-center my-3">
                                <input type="password" name="password" required>
                            </div>
                            <div class="text-center mt-3">
                                <button class="btn btn-info mb-5">Ingresar</button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="row align-self-center">
                    <form action="{{ url('/') }}/requisitos" method="POST">
                        ...
                        <div class="col-xs-12 align-self-center">
                            ...
                            <div class="text-center mt-3">
                                <button class="btn btn-info mb-5">Sign In</button>
                            </div>
                        </div>
                    </form>
                </div>
