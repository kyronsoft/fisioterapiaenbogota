...
<body>
    <div id="app">
        ...
        @include('website.paginas.sliders_en')
        @include('website.paginas.seccion1_en')
        @include('website.paginas.seccion2_en')
        @include('website.paginas.seccion3_en')
        @include('website.paginas.seccion4_en')
        @include('website.paginas.seccion5_en')
