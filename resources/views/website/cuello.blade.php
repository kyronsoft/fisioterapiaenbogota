    ...
    <div id="app">
        @if ($idioma == 'ES')
                    ...
                    <div class="col-xs-12 col-md-6">
                        ...
                        <div class="container d-flex justify-content-center">
                            <div class="col-xs-7 col-md-10">
                                <div class="card">
                                    <h4 class="card-header text-center bg-info text-white">Dolor de Cuello y Hombro</h4>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="container folleto-boton">
                <div class="row d-flex justify-content-center">
                    <div class="col-xs-12 col-md-8">
                        <img src="{{ url('/') }}/storage/port-3-spa.png" class="img-fluid" alt="" id="libro_dolor">
        ...
        @elseif ($idioma == 'EN')
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-xs-12 col-md-6">
                        ...
                        <div class="container d-flex justify-content-center">
                            <div class="col-xs-7 col-md-10">
                                <div class="card">
                                    <h4 class="card-header text-center bg-info text-white">Neck And Shoulder Pain</h4>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="container folleto-boton">
                <div class="row d-flex justify-content-center">
                    <div class="col-xs-12 col-md-8">
                        <img src="{{ url('/') }}/storage/port-3-eng.png" class="img-fluid" alt="" id="libro_dolor">
                        <a href="{{ url('/') }}/download_neck" class="btn btn-info">Download</a>
                    </div>
                </div>
            </section>
        @endif
