                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    ...
                    <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="{{url('fisioterapia')}}">{{$websitemenu[6]->spanish}}</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{url('cuello')}}">{{$websitemenu[7]->spanish}}</a></li>
                            <div class="dropdown-divider"></div>
                            <li><a class="dropdown-item" href="{{url('espalda')}}">{{$websitemenu[8]->spanish}}</a></li>
                            <div class="dropdown-divider"></div>
                            <li><a class="dropdown-item" href="{{url('rodilla')}}">{{$websitemenu[9]->spanish}}</a></li>
                            <div class="dropdown-divider"></div>
                            <li><a class="dropdown-item" href="{{url('deportivas')}}">{{$websitemenu[10]->spanish}}</a></li>
                        </ul>
                </ul>
            </li>
            <li class="nav-item">
