<div class="container-fluid bg-primary barra-superior">
    ...
    <div class="col-xs-3 col-sm-3 align-self-center text-white text-center">{{$websiteheader[0]->spanish}}</div>
        ...
        <div class="d-none d-sm-block col-sm-3 text-white text-center pt-3 redes-up">
            ...
            <li class="list-inline-item"><a href="{{url($websiteheader[3]->spanish)}}"target="_target"><i class="fa fa-linkedin-square fa-2x"
                            aria-hidden="true"></i></a></li>
                <li class="list-inline-item"><a href="{{url($websiteheader[4]->spanish)}}"target="_target"><i class="fa fa-facebook-square fa-2x"
                            aria-hidden="true"></i></a></li>
                <li class="list-inline-item"><a href="{{url($websiteheader[5]->spanish)}}"target="_target"><i class="fa fa-instagram fa-2x"
                            aria-hidden="true"></i></a></li>
                <li class="list-inline-item"><a href="{{url($websiteheader[6]->spanish)}}"target="_target"><i class="fa fa-youtube fa-2x" aria-hidden="true"></i></a>
                </li>
            </ul>
        </div>
    </div>
