...
<body>
    <div id="app">
        ...
        <section class="container-fluid d-flex justify-content-start acerca-uno punto-partida">
            <div class="col-xs-6 col-md-5 align-self-center bg-white columna1">
                <div class="text-justify">@php echo $textos[62]->english; @endphp</div>
            </div>
        </section>
        ...
        <section class="container-fluid d-flex justify-content-end acerca-dos">
            <div class="col-xs-6 col-md-5 align-self-center bg-white columna2">
                <div class="text-justify">@php echo $textos[63]->english; @endphp</div>
            </div>
        </section>
        ...
        <section class="container-fluid d-flex justify-content-start acerca-tres">
            <div class="col-xs-6 col-md-5 align-self-center bg-white columna3">
                <div class="text-left py-5">@php echo $textos[64]->english; @endphp</div>
            </div>
        </section>
        ...
        <section class="container-fluid d-flex justify-content-end acerca-cuatro">
            <div class="col-xs-6 col-md-5 align-self-center bg-white columna4">
                <div class="text-left py-5">@php echo $textos[65]->english; @endphp</div>
            </div>
        </section>
        ...
        <section class="container-fluid d-flex justify-content-start acerca-cinco">
            <div class="col-xs-6 col-md-5 align-self-center bg-white columna5">
                <div class="text-left py-5">@php echo $textos[66]->english; @endphp</div>
            </div>
        </section>
    </div>
