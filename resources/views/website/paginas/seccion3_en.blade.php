<section class="container-fluid d-flex justify-content-start seccion-cuatro">
    <div class="col-xs-5 col-md-6 align-self-center bg-white columna">
        <div class="text-center">@php echo $inicioseccion3[0]->english; @endphp</div>
        <div class="row">
            ...
            <div class="col-xs-10 col-md-11">
                <div class="texto-sec4">@php echo $inicioseccion3[1]->english; @endphp</div>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-2 col-md-1 align-self-center">
            ...
            <div class="col-xs-10 col-md-11">
                <div class="texto-sec4">@php echo $inicioseccion3[2]->english; @endphp</div>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-2 col-md-1 align-self-center">
            ...
            <div class="col-xs-10 col-md-11">
                <div class="texto-sec4">@php echo $inicioseccion3[3]->english; @endphp</div>
            </div>
        </div>
    </div>
</section>
