...
<head>
    ...
    <meta name="title" content="Physiotherapy in Bogotá ✅ Telerehabilitation en Bogotá 🧿">
    ...
    <meta property="og:site_name" content="Physiotherapy in Bogotá ✅ Telerehabilitation en Bogotá 🧿" />
    ...
    <div id="app">
        ...
        <section class="container-fluid d-flex justify-content-center teler-dos">
            <div class="col-xs-6 col-md-5 align-self-center bg-white columna2">
                <div>@php echo $teler[1]->english; @endphp</div>
            </div>
        </section>
        ...
        <section class="container-fluid d-flex justify-content-end teler-tres">
            <div class="col-xs-6 col-md-5 align-self-center bg-white columna3">
                <div>@php echo $teler[2]->english; @endphp</div>
            </div>
        </section>
