...
<head>
    ...
    <meta property="og:description" content="Do you relate? Do you have neck and shoulder pain that is almost constant and may or may not radiate to your arm or hand? Do you suffer
            from pain at the base of the skull and around the forehead as if you had a band around the head? Do you have difficulty turning your head, driving, 
            working at the computer, sleeping, lifting objects and playing sports?">
    ...
    <meta itemprop="name" content="Neck Pain">
                ...
                <div class="col-12">
                    ...
                    <div class="container d-flex justify-content-center">
                        <div class="col-xs-7 col-md-6">
                            <div class="card">
                                <div class="card-header text-center bg-primary">Neck and Shoulder Pain</div>
                            </div>
                        </div>
                    </div>
                </div>
