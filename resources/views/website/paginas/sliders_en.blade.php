        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption">
                    ...
                    <a href="{{url('/')}}/physiotherapy" class="btn btn-primary">Más información sobre Fisioterapia</a>
                </div>
            </div>
            <div class="carousel-item">
                ...
                <div class="carousel-caption">
                    ...
                    <div class="row d-flex justify-content-around">
                        ...
                        <a href="{{ url('/') }}/telerehabilitation" class="btn btn-primary">Más información sobre
