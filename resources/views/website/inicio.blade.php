...
<body>
    <div id="app">
        ...
        @if ($talleres[0]->talleres == 1)
            <x-talleres />
        @endif

        @include('website.paginas.sliders')
        @include('website.paginas.seccion1')
        @include('website.paginas.seccion2')
        @include('website.paginas.seccion3')
        @include('website.paginas.seccion4')
        @include('website.paginas.seccion5')
        @include('website.paginas.seccion6')
