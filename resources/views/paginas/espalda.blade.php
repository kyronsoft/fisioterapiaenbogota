...
<body>
    ...
    <section class="container-fluid d-flex justify-content-center cuello-uno">
        <div class="col-5">
            ...
            <br>
            <h3>{{$textos[162]['spanish']}}</h3>
            <br>
            <p class="text-left">@php echo $textos[163]['spanish']; @endphp</p>
            <p class="text-left">@php echo $textos[190]['spanish']; @endphp</p>
            <p class="text-left">@php echo $textos[195]['spanish']; @endphp</p>
            <p class="text-left">@php echo $textos[196]['spanish']; @endphp</p>
            <p class="text-left">@php echo $textos[197]['spanish']; @endphp</p>
        </div>
    </section>
