...
<body>
    ...
    <section class="container-fluid d-flex justify-content-center contacto">
        <div class="row">
            ...
            <div class="align-self-center">
                <h2 class="text-center ml-3">{{$textos[203]['english']}}</h2>
            </div>
        </div>
    </section>
    ...
    <section class="container-fluid d-flex justify-content-around contacto1">
        <div class="row align-self-center">
            <div class="col-xs-12 col-md-6 align-self-center">
                <h3 class="text-center">{{$textos[204]['english']}}</h3>
                <ul>
                    <li><i class="fa fa-phone-square" aria-hidden="true"></i> {{$textos[205]['english']}}</li>
                </ul>
                <h3 class="text-center">Correo Electrónico</h3>
                <ul>
                    <li><i class="fa fa-envelope" aria-hidden="true"></i> {{$textos[208]['english']}}</li>
                </ul>
            </div>
            <div class="col-xs-12 col-md-6 align-self-center">
                <h3 class="text-center">{{$textos[206]['english']}}</h3>
                <p>@php echo $textos[207]['english']; @endphp</p>
            </div>
        </div>
    </section>
