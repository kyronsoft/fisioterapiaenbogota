...
<body>
    ...
    <section class="container-fluid d-flex justify-content-center cuello-uno">
        <div class="col-5">
            <h3 class="text-center">{{$textos[185]['english']}}</h3>
            <h4 class="text-info text-center">{{$textos[186]['english']}}</h4>
            <div class="alert alert-info text-center mt-5" role="alert">
                {{$textos[161]['english']}}
            </div>
            <br>
            <h3>{{$textos[162]['english']}}</h3>
            <br>
            <p class="text-left">@php echo $textos[163]['english']; @endphp</p>
            <p class="text-left">@php echo $textos[190]['english']; @endphp</p>
            <p class="text-left">@php echo $textos[195]['english']; @endphp</p>
            <p class="text-left">@php echo $textos[196]['english']; @endphp</p>
            <p class="text-left">@php echo $textos[197]['english']; @endphp</p>
        </div>
    </section>
