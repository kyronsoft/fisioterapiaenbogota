...
<body>
    ...
    <section class="container-fluid d-flex justify-content-center cuello-uno">
        ...
        <h3 class="text-center">{{$textos[185]['english']}}</h3>
            ...
            <br>
            <p class="text-justiy">@php echo $textos[187]['english']; @endphp</p>
        <h3 class="text-center">{{$textos[188]['english']}}</h3>
            <p class="text-justiy">@php echo $textos[189]['english']; @endphp</p>
        </div>
    </section>
