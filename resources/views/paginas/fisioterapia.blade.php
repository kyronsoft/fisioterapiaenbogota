...
<body>
    ...
    <section class="container-fluid d-flex justify-content-end fisio-uno">
        ...
        <h3>{{$textos[171]['spanish']}}</h3>
            <p class="text-justify">@php echo $textos[172]['spanish']; @endphp
            </p>
        </div>
    </section>
    ...
    <section class="container-fluid d-flex justify-content-start fisio-dos">
        <div class="col-xs-5 col-md-6 align-self-center bg-white">
            <h3 class="text-center">{{$textos[173]['spanish']}}</h3>
            <h4 class="text-center">{{$textos[174]['spanish']}}</h4>
            <div class="row">
                ...
                <div class="col-xs-10 col-md-11">
                    <p class="text-justify">{{$textos[175]['spanish']}}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-2 col-md-1 align-self-center">
                ...
                <div class="col-xs-10 col-md-11">
                    <p class="text-justify">{{$textos[176]['spanish']}}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-2 col-md-1 align-self-center">
                ...
                <div class="col-xs-10 col-md-11">
                    <p class="text-juestify">{{$textos[177]['spanish']}}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-2 col-md-1 align-self-center">
                ...
                <div class="col-xs-10 col-md-11">
                    <p class="text-juestify">{{$textos[178]['spanish']}}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-2 col-md-1 align-self-center">
                ...
                <div class="col-xs-10 col-md-11">
                    <p class="text-juestify">{{$textos[179]['spanish']}}</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="container-fluid d-flex justify-content-end fisio-tres">
        <div class="col-xs-5 col-md-6 align-self-center bg-white">
            <h3 class="text-center">{{$textos[180]['spanish']}}</h3>
            <h4 class="text-center">{{$textos[181]['spanish']}}</h4>
            <div class="row">
                <div class="col-xs-2 col-md-1 align-self-center">
                    <img src="images/icon-decor-1.png" alt="" class="rounded-circle" style="background-color: #ddb2c6;">
                </div>
                <div class="col-xs-10 col-md-11">
                    <p class="text-justify">{{$textos[182]['spanish']}}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-2 col-md-1 align-self-center">
                ...
                <div class="col-xs-10 col-md-11">
                    <p class="text-justify">{{$textos[183]['spanish']}}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-2 col-md-1 align-self-center">
                ...
                <div class="col-xs-10 col-md-11">
                    <p class="text-juestify">{{$textos[184]['spanish']}}</p>
                </div>
            </div>
        </div>
    </section>
    ...
    @include('comunes.dolores')

    @include('comunes.ayuda')

    @include('comunes.libros')

    @include('comunes.descripcion')

    @include('comunes.servicios')
    
    @include('comunes.contadores')

    @include('comunes.testimonios')

    @include('comunes.faqs')
