...
<body>
    ...
    <section class="container-fluid d-flex justify-content-center cuello-uno">
        <div class="col-5">
            ...
            <p class="text-left">@php echo $textos[166]['spanish']; @endphp</p>
            <p class="text-left">@php echo $textos[198]['spanish']; @endphp</p>
            <p class="text-left">@php echo $textos[199]['spanish']; @endphp</p>
        </div>
    </section>
