...
<body>
    ...
    <section class="container-fluid d-flex justify-content-center cuello-uno">
        <div class="col-5">
            ...
            <p class="text-left">@php echo $textos[169]['english']; @endphp</p>
            <p class="text-left">@php echo $textos[200]['english']; @endphp</p>
            <p class="text-left">@php echo $textos[201]['english']; @endphp</p>
            <p class="text-left">@php echo $textos[202]['english']; @endphp</p>
        </div>
    </section>
