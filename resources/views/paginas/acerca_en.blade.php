...
<body>
    ...
    <section class="container-fluid d-flex justify-content-start acerca-uno">
        <div class="col-xs-6 col-md-6 align-self-center bg-white">
            <h3 class="mt-5">{{$textos[128]['english']}}</h3>
            <p class="text-justify">@php echo $textos[129]['english']; @endphp</p>
            <p class="text-justify">@php echo $textos[130]['english']; @endphp</p>
        </div>
    </section>

    <section class="container-fluid d-flex justify-content-end acerca-dos">
        <div class="col-xs-6 col-md-6 align-self-center bg-white">
            <p class="text-justify">@php echo $textos[131]['english']; @endphp</p>
            <p class="text-justify">@php echo $textos[132]['english']; @endphp</p>
        </div>
    </section>

    <section class="container-fluid d-flex justify-content-start acerca-tres">
        <div class="col-xs-6 col-md-6 align-self-center bg-white">
            <p class="text-justify">@php echo $textos[133]['english']; @endphp</p>
        </div>
    </section>

    <section class="container-fluid d-flex justify-content-end acerca-cuatro">
        <div class="col-xs-6 col-md-6 align-self-center bg-white">
            <p class="text-justify">@php echo $textos[134]['english']; @endphp</p>
        </div>
    </section>

    <section class="container-fluid d-flex justify-content-start acerca-cinco">
        <div class="col-xs-6 col-md-6 align-self-center bg-white">
            <p class="text-justify">@php echo $textos[135]['english']; @endphp</p>
        </div>
    </section>
