...
<body>
    ...
    <section class="container-fluid d-flex justify-content-center cuello-uno">
        <div class="col-5">
            ...
            <p class="text-left">@php echo $textos[169]['spanish']; @endphp</p>
            <p class="text-left">@php echo $textos[200]['spanish']; @endphp</p>
            <p class="text-left">@php echo $textos[201]['spanish']; @endphp</p>
            <p class="text-left">@php echo $textos[202]['spanish']; @endphp</p>
        </div>
    </section>
