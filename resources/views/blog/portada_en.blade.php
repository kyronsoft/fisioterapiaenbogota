                ...
                <div class="col-xs-12">
                    <form action="/blog/busqueda">
                        <div class="input-group mb-3">
                            ...
                            <button type="submit" class="btn btn-primary ml-3 float-right">Search</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            @foreach ($articulos as $element)
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-9 col-lg-6">
                        <h3>{{ $element->titulo_en }}</h3>
                        <h5>{{ $element->descripcion_en }}</h5>
                        <hr>
                        <small
                        ...
                        <a href="{{ url('/') }}/articulo_en/{{ $element->id_articulo }}" class="float-right">Read more</a>
                        <hr class="my-3">
                        <h4>Labels</h4>
                        @php
                        $tags = json_decode($element->p_claves_en, true);
                        if ($tags)
                        ...
                        <div class="row">
                            ...
                            for($i=0;$i<5;$i++){ $imagen=$destacados[$i]->portada_articulo;
                                ...
                                <div class="col-10 align-self-center">
                                    <a href="{{ url('/') }}/articulo_en/{{ $id_articulo }}">{{ $titulo }}</a>
                                </div>
                                @php
                                }
                                @endphp
