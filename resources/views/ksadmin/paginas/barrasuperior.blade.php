    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Barra Superior</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-6">
                    <form action="{{ url('/') }}/ks-admin/barrasup/1" method="POST">
                        @method('PUT')
                        @csrf
                ...
                <div class="col-6">
                    <form action="{{ url('/') }}/ks-admin/barrasup/2" method="POST">
                        @method('PUT')
                        @csrf
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
            ...
            <div class="row">
                <div class="col-6">
                    <form action="{{ url('/') }}/ks-admin/barrasup/3" method="POST">
                        @method('PUT')
                        @csrf
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                ...
                <div class="col-6">
                    <form action="{{ url('/') }}/ks-admin/barrasup/4" method="POST">
                        @method('PUT')
                        @csrf
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
            ...
            <div class="row">
                <div class="col-6">
                    <form action="{{ url('/') }}/ks-admin/barrasup/5" method="POST">
                        @method('PUT')
                        @csrf
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                ...
                <div class="col-6">
                    <form action="{{ url('/') }}/ks-admin/barrasup/6" method="POST">
                        @method('PUT')
                        @csrf
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
            ...
            <div class="row">
                <div class="col-6">
                    <form action="{{ url('/') }}/ks-admin/barrasup/7" method="POST">
                        @method('PUT')
                        @csrf
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
