...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/') }}/css/semantic-ui/tabulator_semantic-ui.min.css">
...
<body>
    <div class="header bg-primary">
        <div class="row d-flex justify-content-around">
            <div class="col-xs-6 align-self-center">
                <p class="pb-3">Administrador de Contenido - KSAdmin</p>
            </div>
            <div class="col-xs-6 align-self-center">
                @guest
                    ...
                    <div class="pb-4">
                        <a href="{{ route('logout') }}"
                            onclick="event.preventDefault();
                                                                            document.getElementById('logout-form').submit();" id="link-logout">
                            {{ __('Salir') }}
                        </a>
                    </div>
            ...
            <ul class="navbar-nav mr-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="{{ url('/ksadmin/inicio/header') }}">Encabezado</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ url('/ksadmin/inicio/seccion1') }}">Sección Uno</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ url('/ksadmin/inicio/seccion2') }}">Sección Dos</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ url('/ksadmin/inicio/seccion3') }}">Sección Tres</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ url('/ksadmin/inicio/seccion4') }}">Video Youtube</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ url('/ksadmin/inicio/seccion5') }}">Esqueleto</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ url('/ksadmin/inicio/seccion6') }}">Tips</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ url('/ksadmin/inicio/seccion8') }}">Sección Ocho</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ url('/ksadmin/inicio/seccion9') }}">Servicios</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ url('/ksadmin/inicio/seccion10') }}">Contadores</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown1">
                        <a class="dropdown-item" href="{{ url('/ksadmin/acerca') }}">Acerca De Adriana</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ url('/ksadmin/nace') }}">Como Nace Fysiopuntura</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown2">
                        <a class="dropdown-item" href="{{ '/ksadmin/telerehab' }}">Telerehabilitación</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ '/ksadmin/fisio' }}">Fisioterapia</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ url('/ksadmin/cuello') }}">Dolor De Cuello</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ url('/ksadmin/espalda') }}">Dolor De Espalda</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ url('/ksadmin/rodilla') }}">Dolor De Rodilla</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ url('/ksadmin/deportivas') }}">Lesiones Deportivas</a>
                        <div class="dropdown-divider"></div>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown3">
                        <a class="dropdown-item" href="{{ '/ksadmin/blog/categorias' }}">Categorias</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ '/ksadmin/blog/articulos' }}">Articulos</a>
                        <div class="dropdown-divider"></div>
    ...
    @if (session('status'))
        <script>
            notie.alert({
                type: 1,
                text: 'Texto actualizado exitosamente!',
                position: 'top'
            })
    ...
    @if (session('articulo-insert'))
        <script>
            notie.alert({
                type: 1,
                text: 'Articulo ingresado exitosamente!',
                position: 'top'
            })
