    ...
    <form @submit.prevent="procesarform">
        ...
        <div class="col-xs-12 col-md-4">
          <div class="form-group">
            <label for="area_dolorosa"
              >Painful area / part of the body affected</label
            >
            <select
              class="form-control"
              name="pregunta1"
        ...
        <div class="col-xs-12 col-md-4">
          <div class="form-group">
            <label for="preocupacion"
              >What is your main concern due to this problem?</label
            >
            <select
              class="form-control"
              name="pregunta2"
            ...
            >
              ...
              <option value="11">
                Fear of losing mobility and independence
              </option>
        ...
        <div class="col-xs-12 col-md-4">
          <div class="form-group">
            <label for="actividades"
              >What activities you cannot perform or are limited by this
              problem</label
            >
            <select
              class="form-control"
        ...
        <div class="col-xs-12 col-md-4">
          <div class="form-group">
            <label for="actividades1"
              >How long have you been suffering from this problem?</label
            >
            <select
              class="form-control"
              name="pregunta4"
      ...
      <div class="row d-flex justify-content-start">
        ...
        <div class="col-xs-12 col-md-4">
          <div class="form-group">
            <label for="metas"
              >The main goal that you would like me to help you achieve
              is:</label
            >
            <select
              class="form-control"
