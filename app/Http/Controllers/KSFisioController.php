...
class KSFisioController extends Controller
{
    ...
    {
        $textos = Textos::where('pagina', 'Fisioterapia')->get();

        return view('ks-admin.fisio', array('textos' => $textos));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/ksadmin/fisio')->with('status', 'Texto actualizado exitosamente!');
    }
}
