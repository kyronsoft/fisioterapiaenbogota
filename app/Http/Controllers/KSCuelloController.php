...
class KSCuelloController extends Controller
{
    ...
    {
        $textos = Textos::where('pagina', 'Cuello')->get();

        return view('ks-admin.cuello', array('textos' => $textos));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/ksadmin/cuello')->with('status', 'Texto actualizado exitosamente!');
    }
}
