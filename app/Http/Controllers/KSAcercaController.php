...
class KSAcercaController extends Controller
{
    ...
    {
        $textos = Textos::where('pagina', 'Acerca')->get();

        return view('ks-admin.acerca', array('textos' => $textos));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/ksadmin/acerca')->with('status', 'Texto actualizado exitosamente!');
    }
}
