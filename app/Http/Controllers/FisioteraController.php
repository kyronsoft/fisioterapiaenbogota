...
class FisioteraController extends Controller
{
    /**
    ...
    {
        $textos = Textos::all();
        $fisio = Textos::where('pagina', 'Fisioterapia')->get();
        ...
        return view('website.fisioterapia', array('textos' => $textos, 'menu' => $menu, 'websiteheader' => $websiteheader, 'fisio' => $fisio, 'youtube' => $youtube, 'idioma' => $idioma));
    }
