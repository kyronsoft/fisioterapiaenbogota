...
class CategoriasController extends Controller
{
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            return datatables()->of(Categorias::all())
                ...
                ->addColumn('acciones', function ($data) {
                    ...
                    $acciones = '
								<a href="' . url()->current() . '/' . $data->id_categoria . '/edit" class="btn btn-warning btn-sm">
        ...
        return view("ksadmin.blog.categorias", array("blog" => $blog, "administradores" => $administradores));
    }
    ...
    public function store(Request $request)
    {
        ...
        $datos = array(
            ...
            "ruta_categoria" => $request->input("titulo_categoria"),
        ...
        if (!empty($datos)) {
            ...
            $validar = \Validator::make($datos, [
                ...
                "imagen_temporal" => "required|image|mimes:jpg,jpeg,png,webp|max:2000000"
            ...
            if (!$datos["imagen_temporal"] || $validar->fails()) {
                ...
                return redirect("/ks-admin/blog/categorias")->with("no-validacion", "");
            } else {

                $aleatorio = mt_rand(100, 999);

                $ruta = "images/" . $aleatorio . "." . $datos["imagen_temporal"]->guessExtension();
                ...
                return redirect("/ks-admin/blog/categorias")->with("ok-crear", "");
            }
        } else {

            return redirect("/ks-admin/blog/categorias")->with("error", "");
        }
    }
    ...
    public function show($id)
    {
        ...
        if (count($categoria) != 0) {
            ...
            return view("ksadmin.blog.categorias", array("status" => 200, "categoria" => $categoria, "blog" => $blog, "administradores" => $administradores));
        } else {

            return view("ksadmin.blog.categorias", array("status" => 404, "blog" => $blog, "administradores" => $administradores));
        }
    }
        ...
        if (!empty($datos)) {
            ...
            if ($validar->fails()) {
                ...
                if ($imagen["imagen_temporal"] != "") {
                    ...
                    $ruta = "images/" . $aleatorio . "." . $imagen["imagen_temporal"]->guessExtension();
                ...
                $datos = array(
                    "titulo_categoria" => $datos["titulo_categoria"],
                ...
                return redirect("/ks-admin/blog/categorias")->with("ok-editar", "");
            }
        } else {
    ...
    public function destroy($id, Request $request)
    {
        ...
        if (!empty($validar)) {
            ...
            return redirect("ksadmin.blog.categorias")->with("no-borrar", "");
        }
    }
}
